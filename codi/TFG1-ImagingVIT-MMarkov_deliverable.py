...
for i in range(X_im_voltage.shape[0]):
    X_markov.append(np.multiply(X_im_voltage[i], X_im_current[i]))

X_markov = np.asarray(X_markov)
...
pd.DataFrame(model.predict(x_images)).to_csv('./Results/predictions_noDownMMarkovViT.csv', index=False, header=False)
pd.DataFrame(y).to_csv('./Results/true_labels_noDownMMarkovViT.csv', index=False, header=False)
pd.DataFrame(history.history).to_csv('./Results/history_noDownMMarkovViT.csv', index=False)

'''
    Obtain Images (Current)
'''
X_images = [X_im_current]
X_images = np.asarray(X_images)
X_images = np.reshape(X_images, (X_images.shape[1], X_images.shape[2], X_images.shape[3], X_images.shape[0]))
...
pd.DataFrame(model.predict(x_images)).to_csv('./Results/predictions_noDownMarkovCurrentViT.csv', index=False, header=False)
pd.DataFrame(y).to_csv('./Results/true_labels_noDownMarkovCurrentViT.csv', index=False, header=False)
pd.DataFrame(history.history).to_csv('./Results/history_noDownMarkovCurrentViT.csv', index=False)

'''
    Obtain Images (Voltage)
'''
X_images = [X_im_voltage]
X_images = np.asarray(X_images)
X_images = np.reshape(X_images, (X_images.shape[1], X_images.shape[2], X_images.shape[3], X_images.shape[0]))
...
pd.DataFrame(model.predict(x_images)).to_csv('./Results/predictions_noDownMarkovVoltageViT.csv', index=False, header=False)
pd.DataFrame(y).to_csv('./Results/true_labels_noDownMarkovVoltageViT.csv', index=False, header=False)
pd.DataFrame(history.history).to_csv('./Results/history_noDownMarkovVoltageViT.csv', index=False)