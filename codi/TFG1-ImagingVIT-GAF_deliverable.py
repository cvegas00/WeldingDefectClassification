...
'''
    Obtain All Images (GASF Voltage)
'''
X_images = [X_gasf_voltage]
...
pd.DataFrame(model.predict(x_images)).to_csv('./Results/predictions_GASFVoltageViT.csv', index=False, header=False)
pd.DataFrame(y).to_csv('./Results/true_labels_GASFVoltageViT.csv', index=False, header=False)
pd.DataFrame(history.history).to_csv('./Results/history_GASFVoltageViT.csv', index=False)

'''
    Obtain All Images (GASF Current)
'''
X_images = [X_gasf_current]
X_images = np.asarray(X_images)
X_images = np.reshape(X_images, (X_images.shape[1], X_images.shape[2], X_images.shape[3], X_images.shape[0]))
...
pd.DataFrame(model.predict(x_images)).to_csv('./Results/predictions_GASFCurrentViT.csv', index=False, header=False)
pd.DataFrame(y).to_csv('./Results/true_labels_GASFCurrentViT.csv', index=False, header=False)
pd.DataFrame(history.history).to_csv('./Results/history_GASFCurrentViT.csv', index=False)

'''
    Obtain All Images (GADF Voltage)
'''
...
pd.DataFrame(model.predict(x_images)).to_csv('./Results/predictions_GADFVoltageViT.csv', index=False, header=False)
pd.DataFrame(y).to_csv('./Results/true_labels_GADFVoltageViT.csv', index=False, header=False)
pd.DataFrame(history.history).to_csv('./Results/history_GADFVoltageViT.csv', index=False)

'''
    Obtain All Images (GADF Current)
'''
X_images = [X_gadf_current]
X_images = np.asarray(X_images)
X_images = np.reshape(X_images, (X_images.shape[1], X_images.shape[2], X_images.shape[3], X_images.shape[0]))
...
pd.DataFrame(model.predict(x_images)).to_csv('./Results/predictions_GADFCurrentViT.csv', index=False, header=False)
pd.DataFrame(y).to_csv('./Results/true_labels_GADFCurrentViT.csv', index=False, header=False)
pd.DataFrame(history.history).to_csv('./Results/history_GADFCurrentViT.csv', index=False)